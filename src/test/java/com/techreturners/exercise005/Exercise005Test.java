...
public class Exercise005Test {
    ...
    @Test
    public void checkEmptySentenceIsNotAPangramWithOneLetterOff() {
        assertFalse(ex005.isPangram("abcdefghijklmnopqrstuvwxy"));
    }

    @Test
    public void checkEmptySentenceIsNotAPangramWithOneLetterOffAndDuplicates() {
        assertFalse(ex005.isPangram("bcdfghirjklmnpqqqrtuvwxyzzzzzzzz"));
    }
    ...
    public void checkSentenceWithMixedUpperAndLowerCaseAndNumbersAndDuplicatesIsAPangram() {
        assertTrue(ex005.isPangram(
                "The fiVE 11 boXing wiZards Jump QuicklY 9001 The fiVE 11 boXing wiZards Jump QuicklY 9001"));
    }
